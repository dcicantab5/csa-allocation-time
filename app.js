...
const CircularStatsRoseChart = () => {
  ...
  return React.createElement(
    ...
    React.createElement('h3', { className: 'text-gray-600 mb-4 text-xl font-bold'}, 'When Are Hospital Beds Allocated? Understanding Patterns in Bed Management Activities'),
    React.createElement('h4', { className: 'text-gray-600 mb-6 text-xl italic' }, 'What We Studied'),
